...
# create file
pid_file="stg-run-ai-sa-google.pid"
...
/home/ubuntu/ml_project/jup_env/bin/jupyter-nbconvert --ExecutePreprocessor.timeout=21600 --to notebook --execute /home/ubuntu/ml_project/notebook_directory/multipool/ai-case-study/staging/stg-run-ai-sa-google.ipynb
