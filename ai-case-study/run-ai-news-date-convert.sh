...
# create file
pid_file="run-ai-news-date-convert.pid"
...
/home/ubuntu/ml_project/jup_env/bin/jupyter-nbconvert --ExecutePreprocessor.timeout=21600 --to notebook --execute /home/ubuntu/ml_project/notebook_directory/multipool/ai-case-study/convert-news-national-medol-date.ipynb
