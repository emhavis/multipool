...
/usr/local/bin/jupyter-nbconvert --ExecutePreprocessor.timeout=21600 --to notebook --execute /home/pi/my-project/tweet-sentiment-analysis/sentiment-analysis-prediction.ipynb
